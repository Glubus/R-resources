...
fn namespaced_strings_and_refs() {
    ...
    assert_eq!(string::auth::TITLE, "Login");
    assert_eq!(
    ...
    assert_eq!(string::auth::TITLE, r::auth::TITLE);
    assert_eq!(
        string::auth::errors::INVALID_CREDENTIALS,
...
fn namespaced_colors_and_dimension() {
    ...
    assert_eq!(color::ui::colors::PRIMARY, "#3366FF");
    // PRIMARY_BUTTON references PRIMARY
    assert_eq!(
        color::ui::colors::PRIMARY_BUTTON,
        color::ui::colors::PRIMARY
    );

    assert_eq!(dimension::ui::dimens::PADDING, "16dp");
    ...
    // Both should be the same
    assert_eq!(color::ui::colors::PRIMARY, r::ui::colors::PRIMARY);
}

#[test]
fn namespaced_arrays() {
    // Type organized
    assert_eq!(string_array::lists::LANGS, &["en", "fr", "es"][..]);
    assert_eq!(int_array::lists::SMALL_NUMBERS, &[1, 2, 3][..]);
    assert_eq!(float_array::lists::RATIOS, &[0.5f64, 1.0, 2.0][..]);
    ...
    // Both should be the same
    assert_eq!(string_array::lists::LANGS, r::lists::LANGS);
}
